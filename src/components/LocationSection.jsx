      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="grid items-start gap-6 sm:gap-8 lg:grid-cols-2 lg:gap-12">
          ...
          <div className="space-y-4 sm:space-y-6">
            ...
            <h2 className="text-lg font-semibold leading-snug text-gray-800 sm:text-xl md:text-2xl">
            ...
            <a
              ...
              className="inline-block text-base font-semibold text-blue-600 transition-colors hover:text-blue-700 hover:underline sm:text-lg"
            >
            ...
            <div className="pt-2 sm:pt-4">
              <h3 className="mb-3 text-xl font-bold text-black sm:mb-4 sm:text-2xl">
                Como Chegar
              </h3>
